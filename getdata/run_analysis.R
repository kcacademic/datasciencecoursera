run_analysis <- function() {
  ...
  ##in the directory where this script is being executed.
	##test data => 2947 obs. of  561 variables; train data => 7352 obs. of  561 variables
	...
	##data frames.
	##Merged=10299 obs. of  561 variables
	...
	##subset=10299 obs. of  66 variables
	...
	##final: 10299 obs. of  68 variables
	...
	##tiny: 180 obs. of 68 variables (grouped by 30 subject & 6 activity)
